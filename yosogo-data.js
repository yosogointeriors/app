...
const YS = (function () {
  ...
  function renderQuotationHTML(quotation, lead, settings, isPreview) {
    ...
    const CANONICAL_ROOM_ORDER = ['Foyer/Entrance','Living Room/Hall','Dining','Kitchen','Crockery Unit','Pooja Unit','Master Bedroom','Bedroom 2','Bedroom 3 / Kids Room','Study/Home Office','Bathroom','Balcony/Utility','Home Theatre','False Ceiling','Furniture','Electrical','Doors'];
    const grouped = {};
